            ...
            {[
              ...
              return (
                <>
                  <h3
                    key={id}
                    className="text-black bg-white px-2 flex relative border border-[#6a6a6a] shadow-2xs items-center cursor-pointer h-8 rounded-lg hover:bg-[#e7e7e7] transition ease-in-out duration-500 hover:-translate-y-1"
                  >
                    {item}
